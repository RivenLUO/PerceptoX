...
from keras.applications import VGG19, vgg19, Xception, xception, VGG16, vgg16
...
class SiameseHyperModelVgg16(kt.HyperModel):
    def __init__(self, num_classes):
        self.num_classes = num_classes
    ...
    def build(self, hp):
        ...
        # Convert RGB to BGR
        img_a = vgg16.preprocess_input(img_a)
        img_b = vgg16.preprocess_input(img_b)
        ...
        # Feature extraction; note unfreezing conv top is at risk of overfitting
        #   Extracting features from VGG19 pretrained with 'place365'
        weights_path = 'Keras_VGG16_places365/vgg16-places365_weights_tf_dim_ordering_tf_kernels_notop.h5'
        feature_extractor = VGG16(include_top=False, weights=weights_path)
